...
export const ROLE_DEFINITIONS: RoleDefinition[] = [
  ...
  },
  {
    ...
    permissions: ['finance.view', 'finance.manage', 'fees.manage', 'payments.record', 'academic.view', 'classes.view', 'attendance.view', 'attendance.manage', 'notifications.view', 'announcements.view'],
  },
  {
